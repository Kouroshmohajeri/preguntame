            ...
            <div className={styles.useCaseGrid}>
              ...
              <div className={styles.useCaseBox}>
                ...
                <p className={styles.featureBoxContent}>
                  ...
                  display live leaderboards to increase participation and focus. Perfect for
                  formative assessments and review sessions.
                </p>
              </div>
              ...
              <div className={styles.useCaseBox}>
                ...
                <p className={styles.featureBoxContent}>
                  Engage audiences during events, workshops, or presentations using live quizzes
                  with instant results and interactive scoring. Break the ice and keep participants
                  actively involved.
                </p>
              </div>
              ...
              <div className={styles.useCaseBox}>
                ...
                <p className={styles.featureBoxContent}>
                  Run fun quizzes for teams, communities, or online meetups with shared game codes
                  and real-time interaction. Foster team building and create memorable experiences
          ...
          <div className={styles.sectionContainer}>
            ...
            <div className={styles.howItWorks}>
              ...
              <div className={styles.step}>
                ...
                <p className={styles.stepDescription}>
                  Get a unique game code and share it with participants. They can join instantly
                  from any device.
                </p>
              </div>
          ...
          <div className={styles.sectionContainer}>
            ...
            <div className={styles.threeColumnGrid}>
              ...
              <div className={styles.featureBox}>
                ...
                <p className={styles.featureBoxContent}>
                  Powered by WebSocket technology for instant synchronization and live updates
                  during gameplay.
                </p>
              </div>
